...
const PWTT = "DMXLf9z4x6mPlptmmvt0HM6i9oqPQFTQpSOjeORSa54Dm2O-dyFixw9qm6KCMYbaWB06ityzwy5iul0Oujspzg=="
...
function callserver(fluxstr:str, token:str) {   

    return new Promise<str>(async (res, _rej)=> {
