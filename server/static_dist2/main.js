...
window.addEventListener("load", async (_e)=>{
	...
	*/ await IndexedDBM.Init(INSTANCE.INFO.indexeddb_stores, INSTANCE.INFO.firebase.project, INSTANCE.INFO.firebase.dbversion);
    DataSync_Init(INSTANCE.INFO.indexeddb_stores, INSTANCE.INFO.firebase.project, INSTANCE.INFO.firebase.dbversion, window.APPVERSION);
    /*
	setTimeout(() => {
