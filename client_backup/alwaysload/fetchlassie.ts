...
function FetchLassie(url:str, http_opts:HttpOptsT|null|undefined, opts:OptsT|null|undefined) { return new Promise(async res=> { 

    const i = que_i++

    set_pre(url, i)

    http_opts = http_opts || { method: "GET", headers: {}, body: null }
